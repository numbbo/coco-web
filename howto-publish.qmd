...
In both cases, first, the data need to be prepared.
For this, carefully follow the experimental setup ([Sections 2-4 here](./pdfs/bbobdocexperimentation2013.pdf)),
or use one of the example experimentation scripts ([see e.g. here](./getting-started/#experiment)).
Then, for each dataset (that is, for each benchmarked algorithm variant):
...
[gh-issue]: https://github.com/numbbo/data-archive/issues/new?template=submit-a-coco-data-set.md
...
For this:
  ...
  1. **Open an** [**issue** at the numbbo/data-archive Github repository of COCO](https://github.com/numbbo/data-archive/issues)
     (you need to have a Github account) signaling the URL of the archive with
     a short description of the dataset(s) in the archive.
     The URL shall be added to the file [`list_known_archives.txt`](https://github.com/numbbo/data-archive/blob/gh-pages/data-archives/list_known_archives.txt)
     at [`numbbo/data-archive/data-archives`](https://github.com/numbbo/data-archive/blob/gh-pages/data-archives).
