...
and is divided into _two main parts_ which can be used independently:

- [`coco-experiment`](#running-an-algorithm-on-a-coco-benchmark-suite-experiment) for running experiments and
- [`coco-postprocess`](#displaying-benchmarking-results-postprocess) for displaying benchmarking data.
