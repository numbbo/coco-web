...
(for other languages see the instructions in [`code-experiments/build`](https://github.com/numbbo/coco-experiment/tree/main/build) _and_ in the respective subfolder).
