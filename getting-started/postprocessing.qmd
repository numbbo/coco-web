---
title: Getting started---Analysing and comparing results (postprocessing)
---
...
This call creates hundreds of figures and modifies and opens `ppdata/index.html` in a browser, and finally returns a data set list of all read-in data.
