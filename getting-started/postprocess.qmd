...
```
gives these empirical runtime distributions (runtime profiles) for three algorithms for all `bbob`-functions in 20-D (left) and for `bbob`-functions 6 and 14 (among others).

|             |             |             |
| ----------- | ----------- | ----------- |
| ![image](images/CMA-E_NELDE_SLSQP_pprldmany_20D_noiselessall.svg) | ![image](images/CMA-E_NELDE_SLSQP_pprldmany_f006_20D.svg) | ![image](images/CMA-E_NELDE_SLSQP_pprldmany_f014_20D.svg) |
