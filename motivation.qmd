...
Generally, a decent light-weight (but somewhat fragile) benchmarking _can_ be done[^light] _without_ dealing with the most intricate aspects in COCO, which are 
...
[^intricate]: The most intricate features of COCO are 

[^knowing]: We don't quite believe that anyone has enough information, at this point in time, to make a truly educated guess for how real world distributions of broader problem classes look like.
